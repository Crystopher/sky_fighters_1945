	...
	LEVEL_ENEMY_WAVES = [
		...
		},
		{
			...
			"enemies": [
				...
				{"type": "chopter_dfollow", "number": 2, "wait": 1.0},
			]
		},
		{
			"name": "wave1", 
		...
		},
		{
			...
			"type": "enemy",
			"enemies": [
				{"type": "enemy_turret", "number": 1, "wait": 2},
				{"type": "enemy_turret", "number": 1, "wait": 6},
				{"type": "enemy_turret", "number": 1, "wait": 6},
				{"type": "enemy_turret", "number": 1, "wait": 6},
				{"type": "enemy_turret", "number": 1, "wait": 6},
			]
		},
		{
			...
			"enemies": [
				...
				{"type": "chopter_dspitfire", "number": 2, "wait": 3},
				{"type": "chopter_darc_shooter", "number": 2, "wait": 1.5},
		...
		},
		{
			...
			"enemies": [
				...
				{"type": "chopter_dspitfire", "number": 2, "wait": 3},
				{"type": "chopter_strafer", "number": 1, "wait": 1.5},
				{"type": "chopter_dfollow", "number": 2, "wait": 1.5},
			]
		},
		{
			"name": "wave6", 
		...
		},
		{
			...
			"type": "enemy",
			"enemies": [
				{"type": "chopter_dfollow", "number": 3, "wait": 2.0},
