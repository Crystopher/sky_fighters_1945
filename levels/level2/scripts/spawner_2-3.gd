	...
	LEVEL_ENEMY_WAVES = [
		...
		},
		{
			...
			"enemies": [
				...
				{"type": "enemy_turret", "number": 1, "wait": 6.0},
				{"type": "enemy_turret", "number": 1, "wait": 6.0},
				{"type": "enemy_turret", "number": 1, "wait": 6.0},
				{"type": "chopter_dspitfire", "number": 3, "wait": 1.0},
				{"type": "chopter_dfollow", "number": 1, "wait": 1.5},
			]
		},
		{
			"name": "wave1", 
			...
			"type": "enemy",
			"enemies": [
				{"type": "chopter_dspitfire", "number": 2, "wait": 1.0},
				{"type": "chopter_dspitfire", "number": 2, "wait": 3.0},
				{"type": "chopter_darc_shooter", "number": 1, "wait": 1.0},
				{"type": "chopter_darc_shooter", "number": 2, "wait": 0.5},
			]
		},
		{
			"name": "wave2", 
			...
			"type": "enemy",
			"enemies": [
				{"type": "chopter_strafer", "number": 2, "wait": 1.0},
				{"type": "chopter_darc_shooter", "number": 2, "wait": 1.0},
				{"type": "chopter_dspitfire", "number": 2, "wait": 1.5},
				{"type": "enemy_turret", "number": 1, "wait": 1.5},
				{"type": "enemy_turret", "number": 1, "wait": 5},
				{"type": "enemy_turret", "number": 1, "wait": 5},
				{"type": "enemy_turret", "number": 1, "wait": 5.5},
			]
		},
		{
			"name": "wave3", 
			...
			"enemies": [
				...
				{"type": "chopter_darc_shooter", "number": 2, "wait": 1.5},
				{"type": "chopter_dspitfire", "number": 2, "wait": 0.5},
				{"type": "enemy_turret", "number": 1, "wait": 1.5},
				{"type": "enemy_turret", "number": 1, "wait": 6.5},
				{"type": "enemy_turret", "number": 1, "wait": 6.5},
				{"type": "enemy_turret", "number": 1, "wait": 6.5},
			]
		},
		...
		},
		{
			...
			"enemies": [
				...
				{"type": "enemy_turret", "number": 1, "wait": 6.0},
				{"type": "enemy_turret", "number": 1, "wait": 6.0},
				{"type": "chopter_dfollow", "number": 1, "wait": 2.0},
				{"type": "chopter_darc_shooter", "number": 1, "wait": 2.0},
				{"type": "chopter_dspitfire", "number": 2, "wait": 1.5},
				{"type": "chopter_strafer", "number": 2, "wait": 1.5}
			]
		},
